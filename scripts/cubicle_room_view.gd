...
func _ready():
	if GameState.sample_debug_done and GameState.sample_art_done and GameState.sample_music_done:
	...
	elif GameState.music_praise_done:
		DialogueManager.show_dialogue_balloon(load("res://others/music_praise.dialogue"))
